...
import org.mule.runtime.config.internal.BeanGraphBeanDependencyResolver;
import org.mule.runtime.config.internal.BeanGraphLifecycleObjectSorter;
...
public class SpringRegistryLifecycleManager extends RegistryLifecycleManager {
  ...
  class SpringContextInitialisePhase extends MuleContextInitialisePhase {
    ...
    public LifecycleObjectSorter newLifecycleObjectSorter() {
      ...
      BeanGraphBeanDependencyResolver dummyResolver =
          new BeanGraphBeanDependencyResolver(configurationDependencyResolver, declaredDependencyResolver,
                                      autoDiscoveredDependencyResolver, getSpringRegistry());
      return new BeanGraphLifecycleObjectSorter(dummyResolver, orderedLifecycleTypes);
    }
  }
