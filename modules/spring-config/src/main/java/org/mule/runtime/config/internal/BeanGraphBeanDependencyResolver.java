...
public class BeanGraphBeanDependencyResolver implements BeanDependencyResolver {
  ...
  public BeanGraphBeanDependencyResolver(ConfigurationDependencyResolver configurationDependencyResolver,
