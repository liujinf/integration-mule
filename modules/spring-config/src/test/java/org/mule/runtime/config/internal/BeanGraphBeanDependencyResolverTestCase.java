...
public class BeanGraphBeanDependencyResolverTestCase {
  ...
  public void setUp() throws Exception {
    ...
    resolver = new BeanGraphBeanDependencyResolver(configurationDependencyResolver, declaredDependencyResolver,
