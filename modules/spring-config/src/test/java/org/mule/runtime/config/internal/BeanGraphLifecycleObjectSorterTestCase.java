...
public class BeanGraphLifecycleObjectSorterTestCase {

  BeanGraphLifecycleObjectSorter sorter;
  BeanGraphBeanDependencyResolver resolver;

  @Before
  public void setUp() throws Exception {
    resolver = Mockito.mock(BeanGraphBeanDependencyResolver.class);
    sorter = new BeanGraphLifecycleObjectSorter(resolver, new Class<?>[] {
        LockFactory.class,
